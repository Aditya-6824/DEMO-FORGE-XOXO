    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign:'center', marginBottom:28 }}>
          ...
          <h1 style={{ fontSize:22, fontWeight:600, color:'#F0F4FF', margin:0 }}>Welcome back</h1>
          <p style={{ fontSize:14, color:'#4A5578', margin:'6px 0 0' }}>Sign in to your account</p>
        </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <p style={{ textAlign:'center', fontSize:13, color:'#4A5578', margin:0 }}>
            ...
            <Link to="/signup" style={{ color:'#4461F2', textDecoration:'none', fontWeight:500 }}>
              Sign up free
            </Link>
          </p>
        </div>
